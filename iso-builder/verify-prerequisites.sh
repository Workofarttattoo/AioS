...
check_directory "./web"
check_file "./web/aios_launcher.html"
check_file "./web/wolf_icon_head.png"
check_file "./aios"
check_file "./runtime.py"
...
check_directory "./red-team-tools"
echo ""
...
check_file "./iso-builder/build-iso-macos.sh"
check_file "./iso-builder/Dockerfile.iso"
check_file "./iso-builder/docker-compose.yml"
check_file "./iso-builder/README.md"
check_file "./iso-builder/QUICKSTART.md"
check_directory "./iso-builder/output"
